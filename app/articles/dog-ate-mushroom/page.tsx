...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/articles/dog-ate-mushroom" },
  openGraph: {
    title: "My Dog Ate a Mushroom: What Do I Do Right Now",
    description:
      "Your dog ate a wild mushroom. Here's exactly what to do: call your vet, save the mushroom, and get to the clinic. Covers toxic species, symptoms, timelines, and treatment.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": "https://guide.orangutany.com/articles/dog-ate-mushroom",
            },
            url: "https://guide.orangutany.com/articles/dog-ate-mushroom",
          }),
        }}
      />
    </article>
