...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/how-to-identify-poisonous-mushrooms" },
  openGraph: {
    title:
      "How to Identify a Poisonous Mushroom (Hint: Most 'Rules' Are Wrong)",
    description:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id":
                "https://guide.orangutany.com/how-to-identify-poisonous-mushrooms",
            },
            url: "https://guide.orangutany.com/how-to-identify-poisonous-mushrooms",
          }),
        }}
      />
    </article>
