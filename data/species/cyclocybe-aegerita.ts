...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "3-12 cm across. Convex when young, flattening with age, sometimes developing a slight central depression. Surface smooth, dry, occasionally cracking in dry weather. Color ranges from dark brown when young to tawny, pale tan, or almost whitish when mature.",
    gills:
    ...
    stem: "5-15 cm tall, 1-2.5 cm thick. Firm, fibrous, whitish above the ring, brownish below. Has a prominent, persistent membranous ring (annulus) on the upper portion. The ring may collect brown spore deposits from the caps above in clustered fruitings.",
    sporePrint: "Brown to dark brown.",
    odor: "Pleasant, floury, sometimes described as mealy or slightly fruity.",
  },
  habitat:
    "Saprotrophic and weakly parasitic on hardwood trees. Especially associated with poplar (Populus), willow (Salix), elm (Ulmus), and elder (Sambucus). Fruits in dense clusters on stumps, fallen logs, trunk wounds, and exposed roots. Common along rivers and streams where poplars grow. Also cultivated commercially on hardwood logs and supplemented sawdust substrates.",
  season:
    "Spring through autumn, with two main fruiting periods in many regions: April to June and September to November. Can fruit year-round in mild Mediterranean climates. Cultivated specimens are available year-round.",
  range:
    "Native to southern Europe, especially common in Italy, Spain, southern France, Greece, and Turkey. Also found in central Europe, the UK (uncommon), and across temperate Asia. Introduced to parts of North America, Australia, and South America through cultivation.",
  lookAlikes: [
    {
  ...
  stories: [
    {
      title: "Rome's First Cultivated Mushroom",
      text: "Pliny the Elder, writing in the first century AD, described Roman farmers inoculating poplar logs with material from previous mushroom flushes to grow what he called 'fungi of the poplar.' Columella's agricultural manual De Re Rustica provided specific instructions. This makes Cyclocybe aegerita likely the earliest mushroom intentionally cultivated by humans, predating Asian shiitake cultivation by over a thousand years.",
      location: "Rome, Italy",
      source: "Pliny the Elder, Naturalis Historia",
    },
    {
      title: "The Riverside Poplar Bonanza in Puglia",
      text: "A forager from Bari described finding an enormous flush of pioppini on a fallen poplar along the Ofanto River. The cluster weighed over 4 kg and filled two shopping bags. He brought them to a local trattoria, where the chef cooked them with orecchiette pasta, garlic, white wine, and pecorino. The dish was served that evening to a full house.",
      location: "Puglia, Italy",
    },
    {
      title: "China's Pioppino Cultivation Boom",
      text: "While Italy grows pioppini on traditional poplar logs, China has scaled up production dramatically using supplemented sawdust blocks in climate-controlled facilities. Chinese production of Cyclocybe aegerita exceeded 100,000 tonnes annually by the mid-2010s, making it one of the top cultivated specialty mushrooms in Asia.",
      location: "Fujian Province, China",
      source: "International Journal of Medicinal Mushrooms",
    },
  ],
  seoQueries: [
    "pioppino mushroom identification",
    "cyclocybe aegerita edible",
    "black poplar mushroom foraging",
    "agrocybe aegerita cultivation",
    "pioppino mushroom cooking",
    "mushroom growing on poplar tree",
    "pioppino vs galerina",
    "how to grow pioppino mushrooms",
    "cyclocybe aegerita look alikes",
    "pioppino mushroom taste",
    "Italian pioppino mushroom recipes",
    "poplar mushroom identification UK",
    "agrocybe cylindracea edible",
  ],
  funFacts: [
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Pioppino (Cyclocybe aegerita) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Agrocybe_aegerita_22.jpg",
    ...
    },
    {
      ...
      alt: "Pioppino (Cyclocybe aegerita) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Agrocybe_aegerita_221.jpg",
      author: "JovanaKoturov",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0",
    },
    {
      ...
      alt: "Pioppino (Cyclocybe aegerita) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Agrocybe_aegerita_2212.jpg",
      author: "JovanaKoturov",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0",
    },
    {
      ...
      alt: "Pioppino (Cyclocybe aegerita) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Agrocybe_aegerita_222.jpg",
      author: "JovanaKoturov",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0",
    },
