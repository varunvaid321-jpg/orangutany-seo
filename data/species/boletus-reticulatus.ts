...
const species: SpeciesRecord = {
  ...
  identification: {
    ...
    gills: "No gills. Like all boletes, the underside has a sponge-like layer of tubes ending in small round pores. Pores are white when young, becoming yellowish to olive-yellow with age. Do not bruise blue.",
    stem: "6-15 cm tall, 3-6 cm thick. Swollen, club-shaped, especially when young. Pale brown to whitish. Covered with a prominent, fine white reticulation (net-like raised pattern) that typically extends over most of the stem surface. Solid and firm throughout.",
    sporePrint: "Olive-brown.",
    odor: "Pleasant, nutty, with a rich mushroomy quality. Stronger when dried.",
  },
  habitat:
    "Mycorrhizal with hardwoods, especially oaks, beeches, and chestnuts. Prefers warm, well-drained soils in thermophilic (heat-loving) woodland. Common in Mediterranean oak forests, parkland, and along forest edges. Often found in the same locations year after year.",
  season: "May through September, peaking in June and July. Fruits earlier in the year than Boletus edulis, earning its common name. Warm rains in late spring trigger the first flushes.",
  range:
    "Widespread across Europe, especially common in Mediterranean and sub-Mediterranean regions. Found from Portugal to Turkey and from southern Scandinavia to North Africa. Also reported from parts of Asia. The North American distribution is debated, with some collections possibly representing related species.",
  lookAlikes: [
    {
      name: "Boletus edulis (King Bolete / Porcini)",
      slug: "boletus-edulis",
      distinction:
