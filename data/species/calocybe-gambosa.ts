...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "5-15 cm across. Thick, fleshy, convex becoming wavy and irregular with age. White to cream, sometimes with a slight buff or yellowish tint. Surface smooth, dry, sometimes cracking at the margin in dry weather.",
    gills:
      "Crowded, narrow, sinuate (notched where they meet the stem). White to cream. Do not change color significantly with age.",
    stem: "3-7 cm tall, 2-4 cm thick. Stout, solid, white to cream. Smooth, fibrous, sometimes slightly swollen at the base. No ring, no volva.",
    sporePrint: "White.",
    odor: "Very strong, mealy, floury, like wet bread dough or fresh pasta. This smell is one of the most reliable identification features.",
  },
  habitat:
    "Grasslands, chalk downs, hedgerows, woodland edges, road verges, old orchards, and parklands. Prefers calcareous (chalky, limestone) soils. Often forms fairy rings or arcs. Can appear in the same locations year after year. Saprotrophic, feeding on dead organic matter in the soil.",
  season:
    "Spring, typically April through June. Traditionally associated with St. George's Day (April 23rd) in the UK. Peak season is late April to mid-May in most of its European range. One of the earliest edible mushrooms to fruit each year.",
  range:
    "Widespread across Europe, from the UK and Scandinavia south to the Mediterranean. Especially common in England, France, Spain (Basque Country), and Italy. Less common in North America, where it is occasionally reported in the Pacific Northwest and northeastern states.",
  lookAlikes: [
    {
      name: "Deadly Fibrecap (Inocybe erubescens)",
  ...
  stories: [
    {
      ...
      text: "In the Basque Country, perrechicos (St. George's Mushrooms) are a spring delicacy that can fetch 40-80 euros per kilogram in markets. Basque foragers head to mountain meadows in late April and guard their collecting spots fiercely. The mushrooms appear in traditional Basque recipes with scrambled eggs, in revueltos, and alongside spring lamb.",
      location: "Basque Country, Spain",
      source: "Basque Culinary Center",
    },
    {
      title: "A Chalk Downland Ring That Returned for 30 Years",
      text: "A member of the Hampshire Fungus Recording Group documented a St. George's Mushroom ring on the South Downs that she had been visiting every April since the early 1990s. The ring expanded slowly each year, and she estimated it was already decades old when she first found it. By 2020, it measured roughly 12 meters across.",
      location: "South Downs, Hampshire, England",
      source: "Hampshire Fungus Recording Group",
    },
    {
      title: "The Spring Forager's Calendar Marker",
      text: "British foragers use St. George's Mushroom as a calendar event: its appearance signals the start of the foraging year. A popular UK foraging blog described it as 'the mushroom equivalent of the first cuckoo call: proof that winter is actually over and the good months are ahead.'",
      location: "Cotswolds, England",
    },
  ],
  seoQueries: [
    "st george's mushroom identification",
    "calocybe gambosa edible",
    "spring mushroom UK identification",
    "white mushroom april may edible",
    "st george's mushroom vs inocybe",
    "perrechico mushroom basque",
    "calocybe gambosa look alikes",
    "st george's mushroom season",
    "mealy smell mushroom spring",
    "mushroom foraging april UK",
    "st george's day mushroom",
    "white mushroom chalk grassland",
    "calocybe gambosa habitat",
  ],
  funFacts: [
