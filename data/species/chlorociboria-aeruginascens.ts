...
const species: SpeciesRecord = {
  slug: "chlorociboria-aeruginascens",
  ...
  identification: {
    cap: "Fruiting bodies are tiny cup-shaped to disc-shaped structures, 1-5 mm across, rarely up to 10 mm. Vivid blue-green to turquoise on the inner surface, slightly paler on the outer surface. Thin, flexible, with a smooth to finely textured surface. Often found in small clusters.",
    gills:
      "No gills. This is a cup fungus (ascomycete). Spores are produced on the inner surface of the cup.",
    stem: "Absent or very short, just a tiny attachment point connecting the cup to the substrate.",
    sporePrint: "Not practically obtainable due to the small size of the fruiting bodies.",
    odor: "Not distinctive.",
  },
  habitat:
    "Saprotrophic on dead, decorticated (bark-free) hardwood, especially oak, beech, birch, ash, and hazel. The blue-green stained wood is far more commonly encountered than the fruiting bodies. Found in deciduous and mixed woodlands, on fallen branches, logs, and woody debris in contact with the ground.",
  season:
    "Fruiting bodies appear primarily in autumn, typically September through December. However, the blue-green stained wood can be found year-round. The mycelium is active in the wood long before and after fruiting bodies are produced.",
  range:
    "Widespread across the temperate Northern Hemisphere. Common throughout Europe, including the UK, Scandinavia, and continental Europe. Found across temperate North America. Also reported from parts of Asia, Australia, and New Zealand. Often overlooked due to the tiny size of the fruiting bodies.",
  lookAlikes: [
    {
  ...
  stories: [
    {
      ...
      text: "Italian woodworkers of the 15th century created elaborate decorative inlays (intarsia) using naturally green-stained wood for foliage and landscape elements. For centuries, the source of the green color was debated. It was not until modern mycological analysis that researchers confirmed the pigment was xylindein, produced by Chlorociboria species colonizing the wood before it was cut and used.",
      location: "Florence, Italy",
      source: "Studies in Conservation journal",
    },
    {
      title: "Tunbridge Ware's Secret Ingredient",
      text: "The distinctive mosaic woodwork known as Tunbridge ware, produced in Kent, England from the 17th to 19th centuries, used Chlorociboria-stained wood for its green elements. Craftsmen would seek out naturally stained branches in local woodlands. Surviving Tunbridge ware boxes in museum collections still show vivid green after 200+ years.",
      location: "Tunbridge Wells, Kent, England",
      source: "Victoria and Albert Museum",
    },
    {
      title: "Oregon State's Organic Semiconductor Discovery",
      text: "Researchers at Oregon State University demonstrated in 2018 that xylindein, the pigment from Chlorociboria, can function as an organic semiconductor. The discovery opened potential applications in sustainable electronics, solar cells, and transistors. A fungal pigment from rotting wood may one day help power electronic devices.",
      location: "Corvallis, Oregon, USA",
      source: "MRS Communications",
    },
  ],
  seoQueries: [
    "green elfcup identification",
    "chlorociboria aeruginascens",
    "blue green stained wood fungus",
    "green wood fungus identification",
    "xylindein pigment mushroom",
    "turquoise fungus on wood",
    "green elfcup UK woodland",
    "chlorociboria stained wood intarsia",
    "blue green cup fungus",
    "green wood stain natural fungus",
    "chlorociboria aeruginascens vs aeruginosa",
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Green Elfcup (Chlorociboria aeruginascens) fruiting bodies scattered along a fallen beech log in Poland",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Chlorociboria_aeruginascens_kz01.jpg",
    ...
    },
    {
      ...
      alt: "Green Elfcup (Chlorociboria aeruginascens) turquoise cups on decaying wood in Sénart Forest, France",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Chlorociboria_aeruginascens_20061119wb.jpg",
