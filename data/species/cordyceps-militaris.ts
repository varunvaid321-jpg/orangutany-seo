...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "No distinct cap. The fruiting body is a club-shaped to cylindrical stroma, 2-8 cm tall, 3-8 mm wide. Surface is covered in tiny, densely packed bumps (perithecia) that give it a finely granular texture. Color is vivid orange to scarlet-orange, sometimes fading to pale orange with age.",
    gills:
    ...
    stem: "The lower portion of the stroma is smoother and paler (yellowish-orange to whitish), transitioning to the fertile, bumpy upper portion. The base connects to the mummified insect host in the soil.",
    sporePrint: "Not practically obtainable in the field. Spores are released from the perithecia as long, thread-like ascospores that fragment into individual cells.",
    odor: "Mild, not distinctive.",
  },
  habitat:
    "Parasitic on the buried pupae and larvae of moths (Lepidoptera) and other insects in forest soil. Found in deciduous and coniferous woodlands, often in mossy areas with deep leaf litter. The fruiting bodies emerge from the soil above the buried host. Cultivated commercially on grain substrates (rice, wheat) without an insect host.",
  season:
    "Late summer through autumn, typically August through November. Fruiting bodies are most commonly found in September and October.",
  range:
