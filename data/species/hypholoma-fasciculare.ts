...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "2-7 cm across. Convex, becoming broadly convex to flat. Sulfur-yellow at the margin, deepening to orange or tawny-brown at the center. Surface smooth, sometimes with faint veil remnants at the margin when young.",
    gills: "Adnate (broadly attached to the stem). Start sulfur-yellow, then turn greenish-yellow, and finally darken to purple-brown as spores mature. The green tinge in mid-development is distinctive.",
    stem: "5-10 cm tall, slender, curved, sulfur-yellow above and brownish below. Fibrous, often with faint ring zone from the veil. Hollow or stuffed. Grows in dense clusters with stems fused at the base.",
    sporePrint: "Purple-brown to dark violet-brown.",
    odor: "Mushroomy but not distinctive. The intensely bitter taste is a more useful identification feature than the smell.",
  },
  habitat:
    "Saprotrophic on dead wood, especially stumps, fallen logs, and buried roots of both broadleaf and coniferous trees. One of the most common wood-decay fungi in temperate forests. Found in all types of woodland, parks, and gardens wherever dead wood is present.",
  season: "Year-round, though most abundant from September through November. Can fruit in any month during mild weather.",
  range:
    "Cosmopolitan. Found across Europe, North America, Asia, Australasia, and South America. One of the most widely distributed mushroom species on the planet.",
  lookAlikes: [
    {
  ...
  stories: [
    ...
    {
      title: "Confusion with Sheathed Woodtuft in Bavaria",
      text: "In 2015, a German forager near Berchtesgaden collected clusters of mushrooms from beech stumps. He thought he had found Sheathed Woodtuft (Kuehneromyces mutabilis) and cooked a large batch. The bitter taste should have been a warning, but he attributed it to the cooking method. He spent two nights in hospital with liver damage.",
      location: "Berchtesgaden, Bavaria, Germany",
    },
    {
      title: "London Parks Warning Sign",
      text: "In 2017, the Royal Parks organization in London installed small information signs near several dead tree stumps in Richmond Park where Sulphur Tuft fruited prolifically every autumn. The signs warned visitors not to pick or eat any mushrooms growing on dead wood without expert identification.",
  ...
  seoQueries: [
    ...
    "yellow mushroom cluster on stump",
    "hypholoma fasciculare toxicity",
    "sulphur tuft vs honey fungus",
    "sulphur tuft look alikes",
    "green gills mushroom toxic",
    "sulphur tuft symptoms",
    "how to identify sulphur tuft",
    "bitter yellow mushroom on wood",
    "hypholoma fasciculare edibility",
