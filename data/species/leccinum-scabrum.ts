...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "5-15 cm across, convex becoming flatter with age. Smooth, slightly greasy when wet. Color ranges from tan to dark brown, occasionally grayish brown. Margin sometimes slightly overhanging the pore surface.",
    gills:
    ...
    stem: "10-20 cm tall, 2-4 cm thick. White to pale gray, covered in distinctive rough dark scales (scabers) that become more pronounced and darker with age. Straight or slightly curved, often tapering slightly toward the top.",
    sporePrint: "Olive-brown to yellowish brown.",
    odor: "Mild, pleasant, slightly mushroomy. Nothing distinctive.",
  },
  habitat:
    "Strictly mycorrhizal with birch trees (Betula species). Found in birch forests, mixed woodlands with birch present, birch-lined paths, parks, and even suburban gardens where birch has been planted. Prefers mossy, slightly acidic soils. Often fruits in small groups near the base of birch trunks or along root lines.",
  season:
    "Summer through autumn, typically July through November. Peak season is August to October across most of its range. Early fruitings can occur in June after warm rains.",
  range:
    "Widespread across the Northern Hemisphere. Extremely common throughout Europe, especially Scandinavia, the UK, Russia, and the Baltic states. Found across temperate and boreal North America. Also present across northern Asia, from the Urals through Siberia to Japan.",
  lookAlikes: [
    {
      name: "Orange Birch Bolete (Leccinum aurantiacum)",
      distinction:
    ...
    {
      name: "Mottled Bolete (Leccinum variicolor)",
      distinction:
