...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "2-7 cm across. Convex to flat. Whitish ground color covered in concentric rings of pinkish-brown to lilac-brown scales or patches, giving a dappled appearance. Center often darker, with more intact cuticle. Margin sometimes with veil remnants.",
    gills: "Free from the stem, white to cream, crowded. Remain pale throughout the mushroom's life.",
    stem: "3-6 cm tall, relatively stout for its size. White above the ring, covered in pinkish-brown to lilac-brown fibrils below. Ring is fragile, sometimes just a zone of fibers. Base does not have a volva.",
    sporePrint: "White to cream.",
    odor: "Slightly fruity or rubbery. Not strongly distinctive.",
  },
  habitat:
    "Saprotrophic, growing in nutrient-rich, disturbed soils. Found in parks, gardens, flowerbeds, along pathways, near compost, in urban green spaces, and on waste ground. Prefers warm climates with calcareous or nitrogen-rich soils.",
  season: "September through November in the Northern Hemisphere. Occasionally fruits in late spring in Mediterranean climates.",
  range:
    "Southern and western Europe, particularly the Mediterranean region. Common in Spain, France, Italy, Turkey, and Iran. Less common in northern Europe. Rare in North America.",
  lookAlikes: [
    {
  ...
  stories: [
    ...
    {
      title: "Turkish Forager's Fatal Error",
      text: "In 2016, a 60-year-old man in Antalya, Turkey, collected small parasol-like mushrooms from the edge of an olive grove. He cooked and ate them alone. He was found unconscious two days later and died in hospital from liver failure before the mushroom species could be formally confirmed.",
      location: "Antalya, Turkey",
    },
    {
      title: "French Pharmacist Catches It in Time",
      text: "In 2018, a forager in Montpellier brought a basket of small dappled mushrooms to a pharmacy for identification. The pharmacist recognized them as Lepiota brunneoincarnata and advised the forager to discard them immediately. The forager had been planning to serve them that evening to dinner guests.",
  ...
  seoQueries: [
    ...
    "deadly dapperling poisonous",
    "small parasol mushroom deadly",
    "lepiota brunneoincarnata toxicity",
    "deadly dapperling symptoms",
    "deadly dapperling vs parasol mushroom",
    "small lepiota mushroom dangerous",
    "lepiota brunneoincarnata amatoxin",
    "deadly dapperling look alikes",
    "how to identify deadly dapperling",
    "small deadly mushroom europe",
    "lepiota brunneoincarnata deaths",
  ],
  funFacts: [
  ...
  images: [
    {
      ...
      alt: "Deadly Dapperling (Lepiota brunneoincarnata) wild specimen",
      ...
      author: "This image was created by user Murselin Guney (Beyrek) at Mushroom Observer, a source for mycological images.You can con",
    ...
    },
    {
      ...
      alt: "Deadly Dapperling (Lepiota brunneoincarnata) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Lange_-_Lepiota_brunneoincarnata.png",
    ...
    },
    {
      ...
      alt: "Deadly Dapperling (Lepiota brunneoincarnata) wild specimen",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Jakob_E._Lange-_Flora_agaricina_Danica._Vol._1-_TAB._13.jpg",
      author: "J.E.Lange",
      license: "Public domain",
      licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
    },
