...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "No cap in the traditional sense. Fruiting body consists of upright, finger-like or antler-like projections, 3-13 cm tall. Bright orange-red to blood-red. Surface is smooth to slightly roughened. Branches may be simple or forked.",
    gills: "None. Spores are produced on the surface of the finger-like projections.",
    stem: "No distinct stem. The projections emerge directly from a base attached to dead wood or soil near buried wood.",
    sporePrint: "White (though collecting a spore print from this species is strongly discouraged due to skin-contact toxicity).",
    odor: "Mild or not distinctive.",
  },
  habitat:
    "Grows on or near dead hardwood stumps and roots, particularly in montane broadleaf forests. Often found near oak and beech. Prefers humid, shaded environments in mountainous terrain.",
  season: "July through October. Most commonly found in late summer and early autumn in Japan and Korea.",
  range:
    "East Asia, primarily Japan, South Korea, and eastern China. Rare outside this region. A few unconfirmed reports from Java and Papua New Guinea.",
  lookAlikes: [
    {
  ...
  stories: [
    {
      title: "The 1999 Japanese Group Poisoning",
    ...
    {
      title: "Korean Hiker Burns Hands on Fire Coral",
      text: "In 2012, a hiker on Jirisan Mountain in South Korea picked several bright red specimens out of curiosity and carried them in his bare hands for about 20 minutes. Within hours, his palms developed severe chemical burns with blistering and skin peeling. He required treatment at a dermatology clinic for three weeks.",
      location: "Jirisan National Park, South Korea",
    },
    {
      title: "Misidentified as Traditional Medicine in China",
      text: "In 2016, a man in Yunnan Province, China, collected red coral-like fungi from a mountainside, believing they were a traditional medicinal fungus. He made a tea from dried specimens. He was hospitalized with liver failure and bleeding gums within 48 hours. He survived after a month of treatment.",
      location: "Yunnan Province, China",
    },
    {
      title: "Japanese Documentary Crew Films With Gloves",
      text: "In 2018, a nature documentary crew filming in Nara Prefecture, Japan, encountered a large cluster of Poison Fire Coral on a dead oak stump. The crew wore nitrile gloves and used long-handled tongs to handle the specimens. The segment aired on NHK and helped raise public awareness about the species.",
      location: "Nara, Japan",
    },
  ],
  seoQueries: [
    ...
    "most dangerous mushroom in the world",
    "mushroom that kills through skin",
    "poison fire coral japan",
    "kaentake mushroom",
    "red coral fungus deadly",
    "podostroma cornu-damae toxicity",
    "trichothecene mushroom poisoning",
    "poison fire coral identification",
    "deadly red fungus east asia",
    "mushroom you can't touch",
    "poison fire coral symptoms",
    "podostroma cornu-damae deaths",
  ],
  funFacts: [
  ...
  images: [
    {
      ...
      alt: "Poison Fire Coral (Podostroma cornu-damae) wild specimen",
      source: "iNaturalist",
