...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "10-25 cm across, 3-6 cm thick. Tongue-shaped, fan-shaped, or roughly semicircular. Upper surface is rough, slightly bumpy, moist to sticky. Color ranges from orange-red when young to dark blood-red or liver-colored when mature. Margin is rounded and thick.",
    gills:
    ...
    stem: "Usually absent or very short and lateral. The bracket attaches directly to the tree trunk, sometimes with a stubby, off-center stalk.",
    sporePrint: "Pinkish-brown to salmon.",
    odor: "Mild, slightly sour, faintly fruity.",
  },
  habitat:
    "Parasitic and saprotrophic on living and dead oak (Quercus) and sweet chestnut (Castanea sativa). Typically fruits from wounds, trunk bases, or old branch scars on mature trees. Occasionally found on other hardwoods. Causes a brown cubical rot of the heartwood.",
  season:
    "Late summer through autumn, typically August through November. Peak season is September to October in most of its range.",
  range:
    "Widespread across Europe, from the Mediterranean to southern Scandinavia. Common throughout the UK and Ireland. Found in eastern North America, from the Great Lakes south to the Gulf Coast. Also reported from parts of Africa and Australia.",
  lookAlikes: [
    {
      name: "Liver-colored Polypore (Ganoderma species)",
      distinction:
  ...
  stories: [
    {
      ...
      source: "Woodland Heritage",
    },
    {
      title: "The Raw Mushroom Steak",
      text: "A London-based forager and chef gained attention by serving raw Beefsteak Fungus carpaccio at a supper club, sliced paper-thin with olive oil, lemon juice, and shaved parmesan. Guests who did not know it was mushroom reportedly asked what kind of beef it was. The red juice pooling on the plate completed the illusion.",
      location: "London, England",
    },
    {
      title: "The Ancient Oak's Secret",
      text: "When a 400-year-old oak in Sherwood Forest was surveyed with a resistograph (a device that measures internal wood density), researchers discovered that nearly 60% of the heartwood had been converted to brown rot by Fistulina hepatica. Despite this, the tree was healthy and still growing. The fungus and the tree had coexisted for possibly over a century.",
      location: "Sherwood Forest, Nottinghamshire, England",
      source: "Ancient Tree Forum",
    },
  ],
  seoQueries: [
    "beefsteak fungus identification",
    "fistulina hepatica edible",
    "mushroom that looks like meat",
    "beefsteak fungus on oak tree",
    "red bracket fungus identification",
    "beefsteak fungus taste",
    "fistulina hepatica cooking",
    "brown oak timber fungus",
    "mushroom that bleeds red",
    "beefsteak fungus season UK",
    "beefsteak fungus look alikes",
    "can you eat beefsteak fungus raw",
    "tongue shaped mushroom on tree",
  ],
  funFacts: [
