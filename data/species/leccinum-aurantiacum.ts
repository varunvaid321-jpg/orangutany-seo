...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "8-20 cm across, sometimes larger. Convex, becoming broadly convex to flattish. Surface is dry to slightly tacky, finely textured. Color ranges from vivid orange to brick-red, reddish-brown, or tawny. Can fade to brownish-orange in dry weather.",
    gills:
    ...
    stem: "12-22 cm tall, 3-5 cm thick. White to pale gray background, densely covered in scabrous scales (scabers) that start pale and darken to brown or black with age. Often club-shaped, thickening toward the base.",
    sporePrint: "Brown to olive-brown.",
    odor: "Mild, pleasant, faintly mushroomy.",
  },
  habitat:
    "Mycorrhizal with birch (Betula) and aspen/poplar (Populus) species. Found in birch woodlands, aspen groves, mixed boreal forests, parklands, and heathlands. Prefers mossy ground and slightly acidic soils. Often fruits in scattered groups along paths and clearings.",
  season:
    "Late summer through autumn, typically August through November. Peak season is September to October in most regions.",
  range:
    "Widespread across the Northern Hemisphere. Common throughout Scandinavia, the UK, continental Europe, Russia, and the Baltic states. Found across boreal and temperate North America, from the Great Lakes region through the Pacific Northwest and into Canada and Alaska.",
  lookAlikes: [
    {
    ...
    {
      name: "Leccinum vulpinum (Foxy Bolete)",
      distinction:
  ...
  stories: [
    {
      ...
      text: "Every September, families across central Russia head to birch and aspen forests on what they call 'quiet hunting' (tikhaya okhota). The Orange Birch Bolete is one of the top targets. Trains from Moscow to surrounding towns are packed with foragers carrying baskets, and roadside mushroom markets spring up along major highways.",
      location: "Moscow Oblast, Russia",
    },
    {
      title: "A Record Leccinum in Norway",
      text: "A Norwegian mycological society member documented a specimen near Trondheim in 2018 with a cap measuring 28 cm across and a stem nearly 25 cm tall. The photos, shared on the society's website, showed a mushroom so large it barely fit in a standard collection basket. Members debated whether it was L. aurantiacum or L. versipelle for weeks.",
      location: "Trondheim, Norway",
      source: "Norwegian Mycological Society",
    },
    {
      title: "The Color-Changing Flesh That Startles Beginners",
      text: "A common post on foraging forums: someone cuts an Orange Birch Bolete in half, watches the white flesh turn pink, then gray, then nearly black within minutes, and panics. Experienced foragers reassure them every time. The oxidation reaction is completely harmless and is actually one of the best confirmation features for the species.",
      location: "Scottish Highlands, UK",
      source: "r/mycology",
    },
  ],
  seoQueries: [
    "orange birch bolete identification",
    "leccinum aurantiacum edible",
    "orange cap mushroom under birch",
    "orange bolete flesh turns black",
    "leccinum aurantiacum vs versipelle",
    "podossinovik mushroom Russia",
    "orange birch bolete cooking",
    "red capped bolete identification",
    "orange bolete look alikes",
    "leccinum aurantiacum foraging",
    "birch bolete orange cap UK",
    "how to prepare orange birch bolete",
    "orange bolete mushroom season",
  ],
  funFacts: [
