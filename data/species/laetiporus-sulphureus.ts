...
const species: SpeciesRecord = {
  ...
  images: [
    ...
    {
      filename: "05-vibrant.jpg",
      alt: "Pristine stacked orange Chicken of the Woods shelves on tree trunk",
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:2017.05.13.-04-Bruehl_Rohrhof--Laetiporus_sulphureus_(Gemeiner_Schwefelporling).jpg",
