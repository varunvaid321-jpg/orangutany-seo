...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "1-3 cm across. Conical to bell-shaped, rarely flattening. Pinkish-brown to reddish-brown or wine-brown, often darker at the center. Surface is smooth, slightly translucent when wet (striate, showing gill outlines). Margin is scalloped or finely toothed and often darker than the rest of the cap. Exudes reddish-purple latex when damaged.",
    gills: "Attached (adnate to slightly decurrent). Pale pinkish to pinkish-gray, sometimes with reddish-brown edges. Moderately spaced. Exude dark reddish-purple latex when cut.",
    stem: "4-8 cm tall, 1-3 mm thick. Slender, wiry, tough. Reddish-brown, often with fine whitish hairs (pubescence) at the base. Hollow. Exudes dark reddish-purple to blood-red latex when broken; this is the key identification feature.",
    sporePrint: "White.",
    odor: "Not distinctive. Some report a faintly sweet or earthy smell.",
  },
  habitat:
    "Saprotrophic on decaying hardwood logs, stumps, and fallen branches. Prefers beech, oak, maple, and other deciduous hardwoods. Grows in clusters of a few to several dozen fruiting bodies. Found in deciduous and mixed forests, woodlands, and parks.",
  season:
    "Late spring through autumn, typically May through November. Can fruit throughout the growing season in moist conditions. Peak fruiting in late summer and autumn in most of its range.",
  range:
    "Widespread across the Northern Hemisphere. Common throughout North America, Europe, and temperate Asia. Found wherever suitable decaying hardwood is available. One of the most frequently encountered Mycena species.",
  lookAlikes: [
    {
