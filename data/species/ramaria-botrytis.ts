...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "No cap. Fruiting body is a densely branched, coral-like structure, 8-15 cm tall and up to 20 cm across. Branches arise from a thick, fleshy, whitish base (up to 8 cm wide). Branches divide repeatedly, becoming finer toward the tips. Branch tips are pink, pinkish-purple, or wine-red when fresh, fading to brownish with age.",
    gills:
      "No gills. Spores are produced on the outer surface of the branches.",
    stem: "No true stem. The base is a thick, compact, whitish to pale buff mass from which all branches arise. Flesh is white, firm, and solid when young.",
    sporePrint: "Yellowish to ochre-brown.",
    odor: "Mild, pleasant, slightly sweet or fruity.",
  },
  habitat:
    "Mycorrhizal with mature beech (Fagus) and oak (Quercus) in old-growth and semi-natural deciduous woodlands. Prefers rich, loamy, well-drained soils with deep leaf litter. Found on the forest floor, often partially hidden under leaves. Also reported under conifers in some regions.",
  season:
    "Late summer through autumn, typically August through November. Peak season is September to October in most of its range.",
  range:
    "Widespread across the temperate Northern Hemisphere. Found throughout Europe (especially common in beech forests of central and southern Europe), across temperate North America, and in parts of temperate Asia (China, Japan, Korea). Less common in northern regions.",
  lookAlikes: [
    {
      name: "Ramaria formosa (Salmon Coral)",
      distinction:
    ...
    {
      name: "Ramaria stricta (Strict-branch Coral)",
      distinction:
    ...
    {
      name: "Cauliflower Fungus (Sparassis crispa)",
      distinction:
