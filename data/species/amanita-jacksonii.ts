...
const species: SpeciesRecord = {
  ...
  identification: {
    ...
    gills: "Free (not attached to the stem). Yellow to orange-yellow. Crowded and broad. This yellow gill color is a critical identification feature that separates it from white-gilled deadly Amanitas.",
    stem: "8-18 cm tall, 1-2.5 cm thick. Yellow to orange-yellow, often with faint zigzag banding or patterning. Base is enclosed in a large, thick, persistent white volva (sac). No ring (annulus) on the stem, which is another important distinction from many deadly Amanitas.",
    sporePrint: "White to pale cream.",
    odor: "Mild, pleasant, slightly nutty. Not distinctive.",
  },
  habitat:
    "Mixed hardwood and oak-dominated forests. Mycorrhizal, forming partnerships primarily with oaks and other hardwoods. Prefers well-drained, acidic soils on slopes and ridges. Often found along trails and in open woodland with good light penetration.",
  season: "June through October, with peak fruiting in July and August. Requires warm temperatures and summer rains.",
  range:
    "Eastern North America, from southern Ontario through the Appalachian region to the Gulf Coast. Most common in the southeastern United States, particularly the Carolinas, Tennessee, Virginia, and Georgia. Also found in parts of Mexico and Central America.",
  lookAlikes: [
    {
