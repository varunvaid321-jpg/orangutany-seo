...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "No true cap. The fruiting body is a lumpy, irregular ball or club shape, 5-20 cm tall and 5-15 cm across. Surface is tough, leathery, and cracked, ranging from yellowish-brown to dark chocolate brown. Often partially buried in soil with only the upper portion visible.",
    gills:
    ...
    stem: "No distinct stem. The base tapers into root-like mycelial strands (rhizomorphs) that connect to tree roots underground. These bright yellow rhizomorphs are sometimes visible at the soil surface.",
    sporePrint:
  ...
  habitat:
    "Found in sandy, gravelly, or disturbed soils near trees it partners with. Common along roadsides, parking lots, gravel paths, building sites, and forest edges. Thrives in poor, compacted, acidic soils that most fungi avoid. Almost always associated with pine, eucalyptus, oak, or birch roots. Often fruits where pavement meets soil, pushing up through cracks.",
  season:
    "Summer through late autumn in temperate regions. In warmer climates (Mediterranean, subtropical), fruiting bodies can persist for weeks or months because the tough exterior resists decay. Peak season July through October in North America and Europe.",
  range:
    "Cosmopolitan. Found across North America (especially southeastern US and California), throughout Europe (Mediterranean region, France, Portugal, Spain), across Australia and New Zealand (often with planted eucalyptus and pine), in southern Africa, and parts of Asia. Expanded its range through forestry plantations that introduced its host trees to new continents.",
  lookAlikes: [
    {
      ...
      externalUrl:
        "https://www.inaturalist.org/taxa/56065-Scleroderma-citrinum",
    ...
    {
      name: "Dead Man's Foot (Pisolithus tinctorius)",
      distinction:
  ...
  seoQueries: [
    "dyeball mushroom",
    "pisolithus arhizus identification",
    "dyeball mushroom dye",
    "pisolithus tinctorius vs arhizus",
    "dyeball puffball",
    "mushroom natural dye brown",
    "pisolithus arhizus edible",
    "dyeball mushroom look alikes",
    "pisolithus mycorrhizal fungus",
    "dyeball mushroom foraging",
    "how to identify dyeball",
    "pisolithus arhizus habitat",
    "mushroom that breaks through pavement",
    "dyeball vs earthball",
    "pisolithus reforestation",
    "natural mushroom dye wool",
    "pisolithus arhizus spores",
    "dead mans foot mushroom",
    "dyeball mushroom range distribution",
  ],
  stories: [
    {
  ...
  images: [
    {
      ...
      alt: "Pisolithus arhizus fruiting body emerging from sandy soil",
      source: "Wikimedia Commons",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Pisolithus_arhizus_(2).jpg",
      author: "Joseba Castells",
    ...
    },
    {
      ...
      source: "Wikimedia Commons",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Pisolithus_arhizus_(Scop.)_Rauschert_913349.jpg",
      author: "2012-09-10 Pisolithus arhizus",
