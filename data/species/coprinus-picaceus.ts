...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "5-8 cm tall when closed, expanding to 6-10 cm across when open. Initially egg-shaped to cylindrical, expanding to conical or bell-shaped before deliquescing. Black to very dark brown, covered with large, irregular white patches of veil remnants. Surface between patches is smooth. Flesh is thin and fragile.",
    gills: "Free (not attached to stem). White when very young, rapidly darkening to gray, then black, before dissolving into inky black liquid (deliquescence). Crowded and very thin.",
    stem: "10-25 cm tall, 1-2 cm thick. White, smooth to finely fibrillose, hollow. Tall and slender, often slightly wider at the base. No ring. Surface is smooth and white throughout.",
    sporePrint: "Black. Easily obtained by catching the inky liquid that drips from the dissolving cap.",
    odor: "Unpleasant when mature, described as chemical or tar-like by some observers. Young specimens have a milder, nondescript odor.",
  },
  habitat:
    "Saprotrophic on buried wood and rich leaf litter in deciduous woodlands. Strongly associated with beech (Fagus sylvatica) in Europe. Also found under other hardwoods including oak and elm. Prefers deep, undisturbed leaf litter on calcareous (chalky or limy) soils.",
  season:
    "Autumn, typically September through November. Peak fruiting in October in most of its European range. Fruits after sustained autumn rains when soil temperatures begin to cool.",
  range:
    "Primarily European, found across the UK, France, Germany, Scandinavia, and southern Europe wherever beech forests occur. Scattered reports from eastern North America, where it is uncommon. Rare in western North America.",
  lookAlikes: [
    {
      name: "Coprinopsis atramentaria (Common Inkcap)",
  ...
  seoQueries: [
    ...
    "black and white mushroom identification",
    "magpie inkcap edible",
    "coprinopsis picacea beech woods",
    "magpie inkcap uk",
    "black cap white patches mushroom",
    "inkcap mushroom identification",
    "magpie inkcap deliquescence",
    "rare inkcap mushroom beech forest",
    "coprinopsis picacea look alikes",
  ],
  funFacts: [
