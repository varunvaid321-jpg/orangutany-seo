...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "2-7 cm across. Convex to flat. Color ranges from honey-yellow to tawny-orange to deep reddish-brown, darkest in the center. Surface is distinctly slimy/viscid when wet, smooth and shiny when dry. Margin is sometimes faintly striate (showing faint lines from the gills below).",
    gills: "Adnate to slightly adnexed (broadly attached to the stem). White to pale yellowish. Moderately spaced. Relatively broad for the size of the mushroom.",
    stem: "3-8 cm tall, 3-8 mm thick. The defining feature: covered in dense, dark brown to black velvety hairs (tomentum), especially from the base upward. The upper portion near the gills may be paler, yellowish. Tough, wiry, somewhat cartilaginous. Older specimens have very dark, almost black stems.",
    sporePrint: "White to pale cream.",
    odor: "Mild, pleasant. Not strongly distinctive.",
  },
  habitat:
    "Saprobic and weakly parasitic on dead and dying hardwoods. Strongly associated with elm (Ulmus), willow (Salix), poplar (Populus), and ash (Fraxinus). Found on stumps, fallen logs, standing dead trees, and wounds on living trees. Often in riparian areas and urban settings where these host trees are common.",
  season:
    "Late autumn through early spring: November through March in the Northern Hemisphere. One of the few mushrooms that fruits actively during winter. Can survive freezing and resume growth during thaws. Peak fruiting during mild spells in December through February.",
  range:
    "Widespread across the Northern Hemisphere. Found throughout Europe, North America, and East Asia. Common in the British Isles, continental Europe, eastern North America, and Japan. Also present in parts of Australia. Particularly common in urban and suburban areas on dying elm trees.",
  lookAlikes: [
    {
    ...
    },
    {
      ...
      externalUrl: "https://en.wikipedia.org/wiki/Xeromphalina_campanella",
  ...
  seoQueries: [
    ...
    "wild enoki vs cultivated enoki",
    "flammulina velutipes edible",
    "velvet foot mushroom winter",
    "wild enoki look alikes",
    "enoki vs galerina marginata",
    "winter mushroom foraging",
    "orange mushroom on dead wood winter",
    "how to identify wild enoki",
    "flammulina velutipes habitat",
    "enoki mushroom health benefits",
    "velvet stem mushroom identification",
    "mushroom that grows in winter",
  ],
  funFacts: [
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Velvet Shank (Flammulina velutipes) cluster on birch trunk in winter",
      source: "iNaturalist",
      sourceUrl: "https://www.inaturalist.org/observations/334390938",
      author: "Grace Merkert",
      license: "CC BY 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by/4.0",
    },
    {
      filename: "02-field.jpg",
      alt: "Velvet Shank (Flammulina velutipes) dense cluster on wet log in England",
      source: "iNaturalist",
      sourceUrl: "https://www.inaturalist.org/observations/335474651",
      author: "Cara Ennis",
      license: "CC BY 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by/4.0",
    },
