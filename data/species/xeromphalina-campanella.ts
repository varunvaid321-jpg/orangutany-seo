...
const species: SpeciesRecord = {
  slug: "xeromphalina-campanella",
  commonName: "Golden Trumpet",
  scientificName: "Xeromphalina campanella",
  taxonomy: {
    kingdom: "Fungi",
  ...
  identification: {
    cap: "0.5-2.5 cm across. Bell-shaped to convex, becoming flatter with age. Thin and somewhat translucent. Golden orange to tawny, sometimes yellowish, paler and more striate (showing radiating lines) toward the margins. Surface is smooth and dry.",
    gills: "Decurrent (running down the stem). Widely spaced, yellowish to pale orange. Connected by cross-veins that form a visible network between the main gills. This cross-vein feature is a useful identification aid under a hand lens.",
    stem: "1-3 cm tall, very thin (1-2 mm). Wiry, tough, and curved. Dark brown to blackish at the base, becoming yellowish toward the cap. Covered in fine hairs at the base. Grows directly from rotting wood.",
    sporePrint: "White to pale buff.",
    odor: "Mild, not distinctive.",
  },
  habitat:
    "Exclusively on decaying conifer wood, especially spruce, pine, fir, and hemlock. Grows on logs, stumps, fallen branches, and buried wood in various stages of decomposition. Saprotrophic. Fruits in very dense clusters, often covering entire log surfaces.",
  season: "May through November, with peak fruiting in summer and early autumn. Can persist for weeks due to the tough, wiry texture of the fruiting bodies.",
  range:
    "Circumboreal. Widespread across the northern temperate and boreal zones of North America, Europe, and Asia. Common wherever conifer forests exist. One of the most frequently encountered small wood-decomposing fungi in the northern hemisphere.",
  lookAlikes: [
    {
      ...
      externalUrl: "https://www.mushroomexpert.com/chrysomphalina_chrysophylla.html",
