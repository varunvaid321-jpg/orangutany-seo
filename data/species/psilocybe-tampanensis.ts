...
const species: SpeciesRecord = {
  slug: "psilocybe-tampanensis",
  commonName: "Philosopher's Stone / Magic Truffle",
  scientificName: "Psilocybe tampanensis",
  taxonomy: {
    kingdom: "Fungi",
  ...
  identification: {
    cap: "1-2.4 cm across. Convex to plane, sometimes with a slight umbo. Ochraceous-brown to straw-colored, paler when dry. Smooth, slightly sticky when moist. Hygrophanous.",
    gills: "Adnate, medium-spaced. Brown to dark purple-brown with age. Edges lighter.",
    stem: "2-6 cm tall, 1-2 mm thick. Thin, equal. Yellowish-brown, slightly darker at the base. Bruises blue when handled.",
    sporePrint: "Purple-brown to dark purple-brown.",
    bruising: "Blue-green bruising on stem and cap, sometimes slow to develop. Sclerotia also bruise blue when cut.",
  },
  habitat:
    "The single wild collection was from a sandy meadow in a deciduous area. In cultivation, sclerotia form readily in grain or grass seed substrates. The natural habitat preferences remain poorly understood due to the extreme rarity of wild collections.",
  season: "The only wild collection was made in September. In cultivation, sclerotia form year-round under controlled conditions.",
  range:
    "Known in the wild from a single collection near Tampa, Florida, USA. Has never been refound despite extensive searching. All cultivated material descends from the 1977 Pollock collection.",
  lookAlikes: [
    {
