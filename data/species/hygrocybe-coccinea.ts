...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "2-5 cm across. Convex, becoming broadly convex to flat, sometimes with a slight central depression. Vivid scarlet red, fading slightly toward the margin or with age. Surface smooth, waxy, slightly greasy to the touch, especially when wet.",
    gills:
    ...
    stem: "3-6 cm tall, 5-10 mm thick. Red to orange-red, often paler (yellowish) toward the base. Smooth, dry, hollow, slightly compressed. No ring, no volva.",
    sporePrint: "White.",
    odor: "Not distinctive. Mild, slightly mushroomy.",
  },
  habitat:
    "Unimproved, unfertilized grasslands, including old meadows, pastures, churchyards, lawns, and parklands. Strongly associated with ancient grasslands that have never been plowed or treated with artificial fertilizers. Also found on mossy banks, road verges, and heathlands. Ecology is not fully understood; likely biotrophic, associated with mosses and grass roots.",
  season:
    "Autumn, typically September through December. Peak season is October to November in most of its European range. Fruits after the first cool, wet weather of autumn.",
  range:
    "Widespread across Europe, especially common in the UK, Ireland, Scandinavia, and western France. Also found across temperate North America, and reported from parts of Asia and Australasia. Most abundant in regions with mild, wet autumns and a tradition of low-intensity grazing.",
  lookAlikes: [
    {
      name: "Crimson Waxcap (Hygrocybe punicea)",
      distinction:
      ...
      externalUrl:
        "https://www.first-nature.com/fungi/hygrocybe-punicea.php",
      externalSource: "First Nature",
    },
    {
      name: "Vermilion Waxcap (Hygrocybe miniata)",
      distinction:
