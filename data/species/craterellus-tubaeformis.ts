...
const species: SpeciesRecord = {
  ...
  commonName: "Trumpet Chanterelle",
  ...
  identification: {
    cap: "2-6 cm across. Deeply funnel-shaped with wavy, lobed margins. Brown to grayish brown, sometimes yellowish brown. Surface is slightly scaly or fibrillose. The center often develops a hole that connects to the hollow stem.",
    ...
    stem: "3-8 cm tall, slender and often compressed. Yellow to orange-yellow, distinctly brighter than the cap. Completely hollow throughout. Smooth or slightly grooved lengthwise.",
    sporePrint: "White to pale cream.",
    odor: "Mild, pleasant, slightly fruity. Less aromatic than golden chanterelles.",
  },
  habitat:
    "Coniferous and mixed forests, especially under spruce, pine, and fir. Strongly associated with mossy ground and decaying wood debris. Often grows directly on or beside rotting logs, stumps, and buried wood. Prefers acidic, well-drained soils. Fruits in dense troops.",
  season: "September through December in most of its range. Can persist into January in mild coastal climates. Peak fruiting in October and November.",
  range:
    "Widespread across Europe and North America. Very common in Scandinavia, the British Isles, Central Europe, and the Pacific Northwest of the US. Also found in boreal forests across Canada.",
  lookAlikes: [
    {
      name: "Cantharellus tubaeformis (Yellowfoot Chanterelle)",
