...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "1-2.5 cm across. Conical to bell-shaped, sometimes flattening slightly with age. Tawny brown to ochre-brown, smooth, slightly sticky when moist. Hygrophanous, drying to a paler buff from the center outward. Surface often has fine radial striations when moist.",
    gills: "Attached (adnate to adnexed), fairly crowded. Pale cinnamon-brown when young, darkening to rusty brown as spores mature. Thin and fragile.",
    stem: "3-7 cm tall, 1-3 mm thick. Very slender and fragile, pale brownish, often with a thin, membranous ring (annulus) in the upper third. The ring is easily lost or collapsed against the stem. Base may be slightly enlarged.",
    sporePrint: "Rusty brown to cinnamon-brown. Always take a spore print on any small brown lawn mushroom before making any identification.",
    odor: "Mild, not distinctive. Some report a faintly earthy or mealy smell.",
  },
  habitat:
    "Saprotrophic on decaying organic matter. Found in lawns, gardens, flower beds, wood chip mulch, compost, and disturbed grassy areas. Prefers moist, nutrient-rich soils. Common in suburban and urban settings.",
  season:
    "Spring through autumn in temperate regions. Peak fruiting after warm rains in late spring and early fall. Can appear year-round in mild, wet climates.",
  range:
    "Widespread across North America and Europe. Also reported from parts of Asia and Australia. Especially common in the Pacific Northwest, the upper Midwest, and throughout the British Isles.",
  lookAlikes: [
    {
    ...
    {
      name: "Agrocybe praecox (Spring Fieldcap)",
      slug: "agrocybe-praecox",
      distinction:
  ...
  stories: [
    {
      ...
      text: "A 2017 case report from the Pacific Northwest described a two-year-old who picked and ate small brown mushrooms from the family's backyard lawn. The parents brought the child to the ER when vomiting began eight hours later. Toxicology confirmed amatoxin exposure consistent with Conocybe filaris. The child survived after four days of intensive care, but the case highlighted the danger of lawn-growing amatoxin species that most parents have never heard of.",
      location: "Seattle, Washington, USA",
      source: "Clinical Toxicology Case Reports",
    },
    {
      title: "Mistaken for Psilocybe in a College Town",
      text: "In 2015, two college students in Eugene, Oregon, collected small brown mushrooms from a landscaped wood chip bed, believing they were Psilocybe cyanescens. They brewed a tea and drank it. When they experienced no psychoactive effects but developed stomach cramps twelve hours later, they went to the hospital. Spore analysis of leftover mushrooms identified Conocybe filaris. Both recovered after treatment for mild liver enzyme elevation.",
      location: "Eugene, Oregon, USA",
      source: "Oregon Poison Center",
    },
    {
      title: "The Dog Walker's Discovery",
      text: "A veterinarian in Minneapolis documented a case in 2020 where a Labrador retriever ate Conocybe filaris from a neighbor's lawn during a morning walk. The dog presented with vomiting and lethargy the next day. Liver enzymes were dangerously elevated. After three days of aggressive IV fluids and liver support, the dog survived, but the vet noted that most pet owners would never suspect a tiny lawn mushroom of being lethal.",
      location: "Minneapolis, Minnesota, USA",
      source: "Veterinary Emergency and Critical Care Society",
    },
  ],
  seoQueries: [
    "conocybe filaris identification",
    "deadly lawn mushroom",
    "small brown mushroom in yard poisonous",
    "conocybe filaris vs psilocybe",
    "lawn mushroom that can kill you",
    "amatoxin mushroom in grass",
    "deadly conocybe identification",
    "brown mushroom with ring on lawn",
    "conocybe filaris symptoms",
    "poisonous mushroom in my yard",
    "tiny brown mushroom on lawn dangerous",
    "conocybe filaris spore print",
    "can lawn mushrooms kill you",
    "small deadly mushroom north america",
  ],
  funFacts: [
  ...
  images: [
    ...
    },
    {
      ...
      source: "Wikimedia Commons",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Conocybe_filaris_10774.jpg",
      author: "Nathan Wilson (nathan) at Mushroom Observer",
