...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "4-10 cm across. Convex, becoming flat to slightly depressed in the center. Bright cherry-red to scarlet, occasionally fading to pinkish. Surface smooth, slightly sticky when wet. Skin peels easily from the margin inward, revealing white flesh beneath.",
    gills: "White, brittle, fairly widely spaced. Attached to the stem or slightly free. Snap cleanly when pressed, a classic Russula feature.",
    stem: "4-8 cm tall, white, cylindrical, smooth. Brittle and easily snapped. No ring. Solid becoming spongy with age.",
    sporePrint: "White to very pale cream.",
    odor: "Faintly fruity or like coconut. Sometimes almost odorless.",
  },
  habitat:
    "Mycorrhizal with conifers, especially pine and spruce. Found in damp, mossy coniferous forests, boggy woodlands, and sphagnum-rich areas. Prefers acidic soils with high moisture.",
  season: "July through November. Common from late summer through autumn across its range.",
  range:
    "Widespread across the Northern Hemisphere. Found throughout Europe, North America, and northern Asia. Common in boreal and temperate coniferous forests.",
  lookAlikes: [
    {
  ...
  stories: [
    {
      ...
      text: "During a guided foray in the Cairngorms, Scotland, in 2018, a participant picked a bright red Russula and was about to place it in her basket. The foray leader asked her to nibble a tiny piece of cap and spit it out. The burning, peppery taste hit within seconds. She dropped the mushroom immediately, an object lesson in why the Russula taste test exists.",
      location: "Cairngorms, Scottish Highlands, Scotland",
    },
    {
      title: "Summer Camp Incident in Vermont",
      text: "In 2016, two teenage campers at a summer camp near Stowe, Vermont, ate raw red mushrooms on a dare. Both were vomiting within an hour. Camp staff called poison control, and a mycologist identified the species from photos as Russula emetica. Both teens recovered by the next morning.",
      location: "Stowe, Vermont, USA",
    },
    {
      title: "Russian Grandmother's Boiling Method",
      text: "In the Novgorod region of Russia, an elderly forager described her lifelong practice of collecting Sickeners, boiling them three times with water changes, and pickling them in vinegar and salt. She claimed she had never been sick. A visiting Finnish mycologist documented the conversation in 2014, noting that while the method may reduce toxins, no scientific study has confirmed its safety.",
  ...
  seoQueries: [
    ...
    "is russula emetica poisonous",
    "the sickener mushroom symptoms",
    "red mushroom white gills poisonous",
    "russula emetica toxicity",
    "the sickener vs edible russula",
    "russula emetica look alikes",
    "red russula mushroom identification",
    "russula taste test",
    "how to identify the sickener",
    "russula emetica habitat",
  ],
  funFacts: [
