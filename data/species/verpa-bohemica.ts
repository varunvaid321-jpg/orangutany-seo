...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "2-4 cm tall and wide. Thimble-shaped to bell-shaped, with a wrinkled, brain-like surface of irregular ridges and furrows (not the neat honeycomb pits of true morels). Color is yellowish brown to dark brown. The cap hangs from the top of the stem, attached only at the apex.",
    gills: "None. This is an ascomycete, not a gilled mushroom. Spores form on the outer wrinkled surface of the cap.",
    stem: "6-14 cm tall, often quite long relative to the cap. Whitish to pale cream, sometimes developing brownish stains. Stuffed with cottony, wispy fibers inside (not cleanly hollow like a true morel). Surface is granular or slightly mealy.",
    sporePrint: "Yellow to yellowish brown.",
    odor: "Mild, somewhat earthy. Less aromatic than true morels.",
  },
  habitat:
    "Floodplains, river bottoms, and riparian areas, especially under cottonwood, ash, elm, and tulip poplar. Loves alluvial soil that gets periodic flooding. Also found in moist, low-lying hardwood forests, orchards, and disturbed ground near streams. Often in sandy or silty soil.",
  season: "March through May, typically 2-4 weeks before true morels appear in the same area. One of the earliest spring fungi in many regions.",
  range:
    "Widespread across North America and Europe. In North America, especially common in the Midwest, Great Plains, and Pacific Northwest lowlands. Abundant along major river systems like the Mississippi, Missouri, and Columbia.",
  lookAlikes: [
    {
    ...
    {
      name: "Morchella elata (Black Morel)",
  ...
  seoQueries: [
    ...
    "wrinkled thimble cap mushroom",
    "verpa bohemica edible safe",
    "verpa vs true morel",
    "half free morel identification",
    "is verpa bohemica poisonous",
    "verpa bohemica look alikes",
    "early morel vs real morel",
    "thimble cap mushroom spring",
    "verpa bohemica season",
    "cottonwood morel early spring",
    "how to tell verpa from morel",
  ],
  funFacts: [
