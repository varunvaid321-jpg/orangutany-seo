...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "4-12 cm across. Convex to broadly convex, sometimes flat with age. Color ranges from pale yellowish tan to cinnamon brown to dark brown. Surface is very slimy and viscid when wet, shiny when dry. The skin peels easily from the cap edge toward the center.",
    gills: "No gills. Has tubes ending in small, round, yellowish pores. Young specimens produce milky white to yellowish droplets from the pore surface ('weeping'). These droplets dry to brown granules. Pores are pale yellow, becoming more ochre with age. Do not bruise blue.",
    stem: "3-8 cm tall, 1-2.5 cm thick. Solid, pale yellowish to whitish. No ring. Upper portion dotted with brownish granules (dried droplets), which is the most reliable field character after the weeping pores. No reticulation.",
    sporePrint: "Brown to ochre-brown.",
    odor: "Mild, slightly fruity. Not particularly distinctive.",
  },
  habitat:
    "Exclusively mycorrhizal with pines (Pinus species). Found in pine plantations, pine-dominated natural forests, parks with planted pines, and coastal pine woodlands. Grows in sandy and well-drained soils. Often fruits in large troops of dozens to hundreds of specimens.",
  season: "June through November, with peak fruiting in August and September. Appears after warm summer rains and continues through autumn.",
  range:
    "Nearly cosmopolitan, found wherever pines grow. Native to Europe and North America. Introduced to South America, Australia, New Zealand, South Africa, and parts of Asia alongside pine plantations. One of the most widely distributed boletes in the world.",
  lookAlikes: [
    {
      ...
      externalUrl: "https://en.wikipedia.org/wiki/Suillus_luteus",
  ...
  images: [
    {
      ...
      alt: "Weeping Bolete (Suillus granulatus) wild specimen",
      source: "iNaturalist",
