...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "3-8 cm across. Convex when young, expanding to broadly convex or flat, sometimes with a low umbo. Pale buff to tan or light brown, smooth, slightly hygrophanous (drying paler from center). Surface may crack in dry weather. Flesh is white, firm.",
    gills: "Attached (adnate to slightly sinuate). Pale grayish when young, darkening to brown and then dark brown as spores mature. Moderately crowded.",
    stem: "4-10 cm tall, 5-12 mm thick. White to pale buff, relatively sturdy for the cap size. Has a thin, membranous ring (annulus) that is often fragile and may disappear. Below the ring, the stem may have faint longitudinal striations. Base sometimes slightly bulbous with white mycelial strands.",
    sporePrint: "Dark brown to chocolate brown.",
    odor: "Mealy or farinaceous, like fresh flour. This is a helpful identification feature when fresh.",
  },
  habitat:
    "Saprotrophic on decomposing wood chips, garden mulch, straw, compost, and organic-rich disturbed soil. Common on lawns, park paths, garden borders, flower beds, and any landscaped area with organic amendments. Also found in grasslands and along roadsides.",
  season:
    "Spring through early summer, typically April through June in temperate regions. One of the earliest mushrooms to fruit each year, often appearing within days of the first warm spring rains. Occasional autumn fruitings occur but are less common.",
  range:
    "Widespread across Europe and North America. Also found in parts of Asia, Australia, and New Zealand. Common throughout the temperate zone wherever landscaped areas and gardens provide suitable substrate.",
  lookAlikes: [
    {
      name: "Conocybe filaris (Deadly Conocybe)",
  ...
  seoQueries: [
    ...
    "spring fieldcap mushroom",
    "first mushroom of spring",
    "agrocybe praecox edible",
    "brown mushroom in wood chips spring",
    "spring fieldcap vs conocybe",
    "agrocybe praecox spore print",
    "early spring mushroom identification",
    "agrocybe praecox look alikes",
    "lawn mushroom with ring spring",
    "spring fieldcap taste",
    "agrocybe praecox habitat",
  ],
  funFacts: [
