...
const species: SpeciesRecord = {
  ...
  identification: {
    cap: "5-15 cm across. Convex becoming flat, sometimes slightly depressed in the center. Color is extremely variable: violet, purple, green, olive, gray, or a mixture of several colors on the same cap. Surface is smooth, slightly sticky when wet, and the cuticle peels about halfway to the center.",
    gills: "The defining feature. White to cream, crowded, and FLEXIBLE. Unlike nearly all other Russulas, whose gills are brittle and crumbly, the gills of R. cyanoxantha bend without breaking and feel greasy or oily when rubbed with a finger. This is the single most reliable field test.",
    stem: "5-10 cm tall, 1.5-3 cm thick. White, solid, firm. Smooth or slightly wrinkled. Does not change color when bruised or handled. No ring or volva.",
    sporePrint: "White.",
    odor: "Mild, not distinctive. Faintly mushroomy.",
  },
  habitat:
    "Mycorrhizal with hardwoods, especially beech and oak. Also found with birch and chestnut. Grows singly or in scattered groups on the forest floor in well-drained woodland. Common along trails and in clearings.",
  season: "June through October, with peak fruiting in July and August. Requires warm temperatures and moderate rainfall.",
  range:
    "Widespread across Europe and eastern North America. Very common throughout Central and Western Europe. Also reported from parts of Asia and North Africa. One of the most frequently encountered Russulas in European beech forests.",
  lookAlikes: [
    {
      name: "Russula virescens (Green-Cracked Russula)",
      distinction:
      ...
      externalUrl: "https://www.mushroomexpert.com/russula_virescens.html",
    ...
    },
    {
      ...
      externalUrl: "https://en.wikipedia.org/wiki/Russula_emetica",
